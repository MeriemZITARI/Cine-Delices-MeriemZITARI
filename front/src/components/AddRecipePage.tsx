        ...
        <form className="flex flex-col gap-6">
          ...
          <section className="border rounded-lg p-4 md:p-6 flex flex-col gap-4">
            ...
            <div>
              ...
              {/* Bouton Ajouter pour les ingrédients */}
          ...
          <section className="border rounded-lg p-4 md:p-6 flex flex-col gap-4">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 flex flex-col gap-2">
                <label className="text-sm">Chercher mon film/ma série dans la base de données</label>
                <div className="border rounded">
                  <input type="text" placeholder="Ex : Le seigneur des anneaux" className="input w-full border-none focus:ring-0" />
                </div>
              </div>
              <div className="flex-1 flex flex-col gap-2">
                <label className="text-sm">Année de sortie</label>
                <div className="border rounded">
                  <input type="text" placeholder="Ex: 2001" className="input w-full border-none focus:ring-0" />
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-2">
              <label className="text-sm">Description du Film/Série</label>
              <div className="border rounded">
                <textarea placeholder="Brève description du film ou de la série" className="textarea w-full border-none focus:ring-0" rows={2} />
              </div>
            </div>
          </section>
